      ...
      <main className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
          <header className="text-center mb-12">
            ...
            <blockquote className="text-lg text-muted-foreground italic border-l-4 border-primary pl-6 my-8">
            ...
            <section className="mb-8">
              ...
              <div className="mt-4 p-4 bg-muted rounded-lg">
                ...
                <p className="text-muted-foreground mt-2">
                  Email: <a href="mailto:office@lithiaspringsmethodist.org" className="text-primary hover:underline">office@lithiaspringsmethodist.org</a>
                </p>
                <p className="text-muted-foreground">
                  Phone: <a href="tel:+17709485429" className="text-primary hover:underline">(770) 948-5429</a>
                </p>
              </div>
            </section>
